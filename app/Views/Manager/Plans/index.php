            ...
            <div class="col-md-6">
                <div class="card shadow-lg" style="padding: 10px">
                    <div class="card-header">
                        <?php echo $title ?? ''; ?>
                        <button  id="createPlanBtn" type="button" class="btn btn-success btn-sm float-end" >Criar Categoria</button>
                    </div>
                    <div class="card-body">
                        <a class="btn btn-info btn-sm mt-2 mb-4" href="<?php echo route_to('plans.archived'); ?>">Categorias Arquivadas</a>
...
<?= $this->section('scripts') ?>
    ...
    <?php echo $this->include('Manager/Plans/Scripts/_datatable_all'); ?> <!-- Tudo PRONTO -->
